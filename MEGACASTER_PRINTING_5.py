...
outfile = r"C:\Users\LewisLab\Documents\my__print.pgm"
#myz = 2.82357
g=G(
    direct_write=False,
    outfile=outfile,
...
def circuit_demo(nozzle,height,speed,dwell,pressure):
    g.feed(25)
    g.set_pressure(pressure_box, pressure)
    #
   #
   ...
   # 
    ...
    g.move(x=27)
    g.move(y=-11)
    g.arc(x=-13.5,y=-21,direction='CW',radius=29)
    g.arc(x=-13.5,y=21,direction='CW',radius=29)
    g.move(y=11)
    g.toggle_pressure(pressure_box)
    g.feed(20)
    ...
    g.move(x=25)
    g.move(y=-10)
    g.arc(x=-12.5,y=-20,direction='CW',radius=29)
    g.arc(x=-12.5,y=20,direction='CW',radius=29)
    g.move(y=10)
    g.toggle_pressure(pressure_box)
    g.feed(20)
...
#TPU_spacing_tests(nozzle='z',height=0.4,speed=11,dwell=0.2,pressure=4)


#print_die_wiring_DIE_CONNECTIONS(nozzle='z',height=0.04,speed=1.8,dwell=0.02,pressure=8)
#
##circuit_demo(nozzle='z',height=0.16,speed=5,dwell=0.1,pressure=12)
#g.abs_move(x=0,y=0)
#g.move(x=76)
#g.set_home(x=0,y=0)
##circuit_demo(nozzle='z',height=0.12,speed=5,dwell=0.1,pressure=12)
#g.abs_move(x=0,y=0)
#g.move(x=76)
#g.set_home(x=0,y=0)
#circuit_demo(nozzle='z',height=0.12,speed=5,dwell=0.1,pressure=12)
...
filament_pic_tests(nozzle='z',height=0.35,speed=3,dwell=0.8,pressure=14)
